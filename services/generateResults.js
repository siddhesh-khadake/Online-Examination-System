...
let gresult = (uid,tid)=>{
    return new Promise((resolve,reject)=>{
		...
		var isNegativeScheme = false;
		TestPaperModel.findOne({ _id : tid}, {isNegativeScheme: 1}).then((testResults)=>{
			if(testResults) {
						//console.log("Test: " + testResults);
						isNegativeScheme = testResults.isNegativeScheme;
